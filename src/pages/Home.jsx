          ...
          <div className="grid grid-cols-2" style={{ alignItems: 'center' }}>
            <div>
              ...
              <p className="text-muted" style={{ marginTop: '1.5rem', fontSize: '1.1rem' }}>
                En Packaging Industrial SRL nos dedicamos a optimizar los procesos de embalaje de nuestros clientes. Proveemos materiales resistentes que aseguran la carga durante el transporte y almacenamiento.
              </p>
            ...
            {[
              ...
              <div key={i} className="card text-left">
                ...
                <div className="card-content text-center">
                  <h3>{cat.title}</h3>
                  <Link to={cat.url} className="text-accent" style={{ display: 'inline-block', marginTop: '1rem', fontWeight: 600 }}>Ver más →</Link>
                </div>
              </div>
            ))}
          </div>
